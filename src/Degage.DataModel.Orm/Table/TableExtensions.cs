...
namespace Degage.DataModel.Orm
{
    ...
    public static class TableExtensions
    {
        ...
        /// <returns></returns>
        public static Int32 Execute(this Table tableObj, DbConnection connection, String sql, params DbParameter[] paras)
        {
            Int32 effect = 0;
        ...
        public static Object ExecuteScalar(this Table tableObj, String sql, params DbParameter[] paras)
        {
            Object result = null;
            using (DbConnection connection = tableObj.DbProvider.DbConnection())
            {
        ...
        public static Object ExecuteScalar(this Table tableObj, DbConnection connection, String sql, params DbParameter[] paras)
        {
            Object result = null;
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public static IDriver<T> SelectSQL<T>(this Table tableObj, String sql, IEnumerable<DbParameter> parameters = null) where T : class
        {
            IDriver<T> driver = tableObj.DbProvider.Driver<T>();
            driver.SQLComponent.Append(sql, parameters);
            return driver;
        }
        ...
        public static String GetColumnNamesWithJoinColumn<T>(this Table<T> tableObj, Boolean IsJoinColumn = false) where T : class
        {
            return GetAllColumnNames<T>(tableObj, null, IsJoinColumn);
        }
        ...
        public static IDriver<T> Select<T>(this Table<T> tableObj, Boolean IsJoinColumn = false) where T : class
        {
            ...
            if (IsJoinColumn)
            {
              ...
              (
              BasicSqlFormat.SELECT_FORMAT,
              GetColumnNamesWithJoinColumn<T>(tableObj, IsJoinColumn),
              Table<T>.Schema.TableName
              );
            }
            else
        ...
        /// <returns></returns>
        public static IDriver<T> Decrement<T>(this Table<T> tableObj, Expression<Func<T, Object>> field, Double number = 1) where T : class
        {
            IDriver<T> driver = tableObj.DbProvider.Driver<T>();
