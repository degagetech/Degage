...
namespace Degage.DataModel.Schema.Toolbox
{
    ...
    public class TableExplainContentSymbol : IContentSymbol
    {
        /// <summary>
        /// 继承自 <see cref="IContentSymbol.Symbol"/>
        /// </summary>
        public String Symbol { get; private set; } = "TableExplain";

        /// <summary>
        ///  继承自 <see cref="IContentSymbol.Description"/>
        /// </summary>
        public String Description { get; private set; } = "对表的说明信息";
        ...
        {
            String result = context.TableSchema.Explain;
            return result;
        }
    }
}
