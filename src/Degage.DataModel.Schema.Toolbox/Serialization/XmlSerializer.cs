...
namespace Degage.DataModel.Schema.Toolbox
{
    ...
    public sealed class XmlSerializer
    {
        ...
        public static void Serialize<T>(T obj, String file,String nameSpace=null) where T : class
        {
            System.Xml.Serialization.XmlSerializer xmlSerializer = new System.Xml.Serialization.XmlSerializer(typeof(T), nameSpace);
        ...
        /// <param name="file">文件路径</param>
        /// <returns>实例</returns>
        public static T DeSerialize<T>(String file,String defaultNameSpace=null) where T : class
        {
            T obj = null;
            System.Xml.Serialization.XmlSerializer xmlSerializer = new System.Xml.Serialization.XmlSerializer(typeof(T), defaultNameSpace);
